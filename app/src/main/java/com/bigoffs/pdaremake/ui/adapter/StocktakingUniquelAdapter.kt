 ...
 *Desc:
 */
class StocktakingUniquelAdapter(data : MutableList<UniqueStocktakingBean>) : BaseQuickAdapter<UniqueStocktakingBean,BaseViewHolder>(R.layout.item_three_row_delete,data) {
